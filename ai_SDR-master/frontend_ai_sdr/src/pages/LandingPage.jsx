      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Stay updated with our latest scheduled meetings
            </p>
          </motion.div>
          ...
          {loading ? (
            ...
            <div className="text-center p-12 bg-gray-50 rounded-lg max-w-2xl mx-auto">
              <FaCalendarAlt className="text-5xl text-gray-400 mx-auto mb-4" />
              <p className="text-xl text-gray-500">No upcoming meetings scheduled</p>
              <button
                onClick={() => navigate('/admin/login')}
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600">
                        {meeting.meetingLink ? <FaVideo /> : <FaCalendarAlt />}
                      </div>
                      <div>
                    ...
                    <div className="space-y-3 mb-4">
                      {meeting.meetingDate && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700">
                            {dayjs(meeting.meetingDate).format("MMM D, YYYY")}
                          </span>
                        </div>
                      )}
                      ...
                      {meeting.role && (
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-700">{meeting.role}</span>
                        </div>
                      )}
                    ...
                    <div className="pt-4 border-t border-gray-100">
                      <button
                        onClick={() => navigate('/admin/login')}
                        className="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-300 flex items-center justify-center gap-2"
                      >
                        <FaVideo />
                        View Details
                      </button>
          ...
          {meetings.length > 0 && (
            <div className="text-center mt-12">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate('/admin/login')}
                className="px-8 py-3 bg-gray-100 text-gray-800 rounded-full font-medium hover:bg-gray-200 transition-all duration-300"
              >
                View All Meetings
              </motion.button>
            </div>
